...
<!-- Redesigned per specs/v4/03: the discovery surface comes out of a boxed
     ...
     specs/v4.1/01 — this used to be the site root, doing double duty as
     both landing page and directory. It's now purely the directory; the
     landing page (information-first) lives at "/". -->
<section class="hero">
