...
<div class="rail">
<Quiet title="2 · Staged for review">
	...
	{:else}
		<p class="hint">Nothing staged. Use "+ Add resources" above the library to upload a document, paste text, or scrape a URL — it lands here for review before it's ingested.</p>
	{/if}
</Quiet>
...
<Spotlight title="1 · The library" actions={libraryActions}>
