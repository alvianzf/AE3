...
REASONER_SYSTEM = (
    ...
    "nearby context — that is fabrication even if it sounds plausible. Instead say "
    "plainly that the library has nothing on this specific question and state what "
    "it would need to cover it.\n"
